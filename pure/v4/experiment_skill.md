...
arms_exhausted=loss, architecture, capacity
...
do_not_emit: skip on exhausted arms loss,architecture,capacity (router will not pick them); read_paper of used files — emit action=improve with config_patch
