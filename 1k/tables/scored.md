...
Official FM on this scale is **0.64203**. Kit `evaluate.py` only.
...
| `006_draft` | draft | 0.63535 | 0.67258 | 0.59813 | -0.00640 | {"arch": "deepfm"} |
| `052_multitask` | multitask | 0.63535 | 0.67258 | 0.59813 | -0.01107 | {"aux_click": true} |
| `028_sequence` | sequence | 0.63341 | 0.67253 | 0.59429 | -0.00997 | {"seq_len": 100, "seq_mode": "pool"} |
| `035_architecture` | architecture | 0.63180 | 0.67120 | 0.59240 | -0.01158 | {"arch": "deepfm", "data_scale": "1k"} |
| `044_ablate_c1_s2` | ablate | 0.62890 | 0.66652 | 0.59128 | -0.01448 | {"listwise_gain": "uniform", "loss": "listwise", "seed": 2} |
| `020_ablate_c1_s2` | ablate | 0.62813 | 0.66538 | 0.59087 | -0.01362 | {"loss": "bpr", "seed": 2} |
| `043_ablate_c1_s1` | ablate | 0.62549 | 0.66556 | 0.58542 | -0.01789 | {"listwise_gain": "uniform", "loss": "listwise", "seed": 1} |
| `019_ablate_c1_s1` | ablate | 0.62498 | 0.66480 | 0.58517 | -0.01677 | {"loss": "bpr", "seed": 1} |
| `042_ablate_c1_s0` | ablate | 0.62304 | 0.66502 | 0.58106 | -0.02034 | {"listwise_gain": "uniform", "loss": "listwise", "seed": 0} |
| `009_draft` | draft | 0.62264 | 0.66500 | 0.58028 | -0.01911 | {"loss": "bpr"} |
| `018_ablate_c1_s0` | ablate | 0.62204 | 0.66518 | 0.57890 | -0.01971 | {"loss": "bpr", "seed": 0} |
| `034_debug` | loss | 0.61266 | 0.66284 | 0.56248 |  | config:loss,listwise_gain |

37 scored nodes. Full dump: [`trials.csv`](trials.csv).
